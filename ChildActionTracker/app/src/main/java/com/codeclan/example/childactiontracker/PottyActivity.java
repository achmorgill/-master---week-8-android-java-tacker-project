...
public class PottyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pottySpinner = (Spinner) findViewById(R.id.pottyActivityResult_spinner);
        pottyResultSpinner = (Spinner) findViewById(R.id.pottyActivity_spinner);
        pottyTimeEdit = (EditText) findViewById(R.id.potty_time_edit);
